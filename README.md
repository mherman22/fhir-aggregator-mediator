...
```
src/
  index.js            # Express server, startup validation, OpenHIM registration, clustering
...
tests/
  unit/               # Unit tests (aggregator, pagination, source-monitor, fhir-client, circuit-breaker, config-validator)
...
# Run tests (99 tests, ~93% coverage)
npm test
